...
export default function Pprofil({ navigation }) {
    ...
    useEffect(() => {
        ...
        return fetch('http://51.91.249.185:8069/api/profil_proche?uid=85&get_profil&proche=118')
    ...
    return (
        <View style={{ flex: 1, backgroundColor: 'white' }} >
            ...
            <View style={styles.main_container}>
                <Text style={styles.text}>Nom:</Text>
                <Text style={styles.text1}>proche_asmaaa
</Text>
            </View>
            <View style={styles.main_container}>
                <Text style={styles.text}>Prénom:</Text>
                <Text style={styles.text1}>proche asmaaaa
</Text>
            </View>
            <View style={styles.main_container}>
                <Text style={styles.text}>Civilité:</Text>
            ...
            <View style={styles.main_container}>
                <Text style={styles.text}>Date de naissance:</Text>
                <Text style={styles.text1}>12-04-2020
</Text>
            </View>
            <View style={styles.main_container}>
                <Text style={styles.text}>N° Téléphone ::</Text>
                <Text style={styles.text1}>06457898558</Text>
            </View>
            <View style={styles.main_container}>
                <Text style={styles.text}>e-mail :</Text>
                <Text style={styles.text1}>asmae@gmail.com</Text>
            </View>
            <View style={styles.main_container}>
                <Text style={styles.text}>N° CIN :</Text>
                <Text style={styles.text1}>CIN</Text>
            </View>
            <View style={styles.main_container}>
                <Text style={styles.text}>N° Mutuelle :</Text>
                <Text style={styles.text1}>mutuelle
</Text>
            </View>
            <View style={styles.main_container}>
                <Text style={styles.text}>Adresse :</Text>
                <Text style={styles.text1}>adress
</Text>
            </View>
            <View style={styles.main_container}>
                <Text style={styles.text}>Ville :</Text>
                <Text style={styles.text1}>rabat
</Text>
            </View>
            </ScrollView>
        </View>
